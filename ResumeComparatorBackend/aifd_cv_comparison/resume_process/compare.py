...
from aifd_cv_comparison.utils.compare_settings import CompareSettings
...
def compare_resumes(resumes: list[str | Path], job_posting: JobPosting, settings: CompareSettings) -> None:
...
compare_resumes(Path('../../tests/resumes/Java-Developer-Resume-4_IXHdxCI.pdf'))
